...
//#define EXTPUMP_SIGN_FLASH_LEN_TOTAL           20
...
//#define EXTPUMP_MOTIONPARAM_FLASH_LEN_TOTAL     40
...
//#define EXTPUMP_FACTOR_FLASH_LEN_TOTAL          20

//扩展测量LED PID参数：4+4+12
#define EXTLEDCONTROLLER_SIGN_FLASH_BASE_ADDR          (EXTLEDDAC_DEFAULT_VALUE_FLASH_BASE_ADDRESS + EXTLEDDAC_DEFAULT_VALUE_FLASH_LEN)
...
#define METER_OVER_VALVE_FLASH_BASE_ADDR                 (EXTTHERMOSTAT_PARAM_ADDRESS + EXTTHERMOSTAT_PARAM_LEN_TOTAL)
...
//增益设置  默认设置标志与参数：4+2*1
#define GAIN_CONTROL_SIGN_FLASH_BASE_ADDR                 (METER_OVER_VALVE_PARAM_FLASH_BASE_ADDR + METER_OVER_VALVE_PARAM_FLASH_LEN)
#define GAIN_CONTROL_SIGN_FLASH_LEN                       4
#define GAIN_CONTROL_PARAM_FLASH_BASE_ADDR                (GAIN_CONTROL_SIGN_FLASH_BASE_ADDR + GAIN_CONTROL_SIGN_FLASH_LEN)
#define GAIN_CONTROL_PARAM_FLASH_LEN                      2
#define GAIN_CONTROL_PARAM_FLASH_LEN_TOTAL          	  2
