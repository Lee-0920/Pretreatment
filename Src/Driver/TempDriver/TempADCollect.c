...
#define ADC_CHANNELA              ADC_Channel_11	//温度采集AD通道

#define GPIO_CHANNELA_PIN         GPIO_Pin_1		//温度采集引脚
...
{
	Uint16 temperatureAD[TEMP_COLLECT_COUNT];
    for (int i = 0; i < TEMP_COLLECT_COUNT; i++)
    {
