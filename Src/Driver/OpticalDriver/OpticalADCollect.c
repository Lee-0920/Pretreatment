...
//增益设置档位
#define GAIN_CTRL_REF_C1_PIN          GPIO_Pin_0
#define GAIN_CTRL_REF_C1_PORT         GPIOB
#define GAIN_CTRL_REF_C1_RCC          RCC_AHB1Periph_GPIOB
#define GAIN_CTRL_REF_C1_HIGH()       GPIO_SetBits(GAIN_CTRL_REF_C1_PORT, GAIN_CTRL_REF_C1_PIN)
#define GAIN_CTRL_REF_C1_LOW()        GPIO_ResetBits(GAIN_CTRL_REF_C1_PORT, GAIN_CTRL_REF_C1_PIN)

#define GAIN_CTRL_REF_C2_PIN          GPIO_Pin_1
#define GAIN_CTRL_REF_C2_PORT         GPIOB
#define GAIN_CTRL_REF_C2_RCC          RCC_AHB1Periph_GPIOB
#define GAIN_CTRL_REF_C2_HIGH()       GPIO_SetBits(GAIN_CTRL_REF_C2_PORT, GAIN_CTRL_REF_C2_PIN)
#define GAIN_CTRL_REF_C2_LOW()        GPIO_ResetBits(GAIN_CTRL_REF_C2_PORT, GAIN_CTRL_REF_C2_PIN)

#define GAIN_CTRL_MEA_C1_PIN          GPIO_Pin_7
#define GAIN_CTRL_MEA_C1_PORT         GPIOE
#define GAIN_CTRL_MEA_C1_RCC          RCC_AHB1Periph_GPIOE
#define GAIN_CTRL_MEA_C1_HIGH()       GPIO_SetBits(GAIN_CTRL_MEA_C1_PORT, GAIN_CTRL_MEA_C1_PIN)
#define GAIN_CTRL_MEA_C1_LOW()        GPIO_ResetBits(GAIN_CTRL_MEA_C1_PORT, GAIN_CTRL_MEA_C1_PIN)

#define GAIN_CTRL_MEA_C2_PIN          GPIO_Pin_8
#define GAIN_CTRL_MEA_C2_PORT         GPIOE
#define GAIN_CTRL_MEA_C2_RCC          RCC_AHB1Periph_GPIOE
#define GAIN_CTRL_MEA_C2_HIGH()       GPIO_SetBits(GAIN_CTRL_MEA_C2_PORT, GAIN_CTRL_MEA_C2_PIN)
#define GAIN_CTRL_MEA_C2_LOW()        GPIO_ResetBits(GAIN_CTRL_MEA_C2_PORT, GAIN_CTRL_MEA_C2_PIN)
...
void OpticalADCollect_Gain_Init(void)
{
	GPIO_InitTypeDef GPIO_InitStructure;
    //时钟配置
    RCC_AHB1PeriphClockCmd(GAIN_CTRL_REF_C1_RCC |
    					GAIN_CTRL_REF_C2_RCC |
						GAIN_CTRL_MEA_C1_RCC |
						GAIN_CTRL_MEA_C2_RCC , ENABLE);
    //IO配置
	...
	//ref_c1
	GPIO_InitStructure.GPIO_Pin = GAIN_CTRL_REF_C1_PIN;
	GPIO_Init(GAIN_CTRL_REF_C1_PORT, &GPIO_InitStructure);
	//ref_c2
	GPIO_InitStructure.GPIO_Pin = GAIN_CTRL_REF_C2_PIN;
	GPIO_Init(GAIN_CTRL_REF_C2_PORT, &GPIO_InitStructure);
	//mea_c1
	GPIO_InitStructure.GPIO_Pin = GAIN_CTRL_MEA_C1_PIN;
	GPIO_Init(GAIN_CTRL_MEA_C1_PORT, &GPIO_InitStructure);
	//mea_c2
	GPIO_InitStructure.GPIO_Pin = GAIN_CTRL_MEA_C2_PIN;
	GPIO_Init(GAIN_CTRL_MEA_C2_PORT, &GPIO_InitStructure);

	GAIN_CTRL_REF_C1_LOW();
	GAIN_CTRL_REF_C2_LOW();
	GAIN_CTRL_MEA_C1_LOW();
	GAIN_CTRL_MEA_C2_LOW();
}

Uint16 OpticalADCollect_SetGain(Uint16 gain)
{
	Uint16 Ret = 1;
	TRACE_ERROR("\n OpticalADCollect_SetGain : %d" , gain);
	switch(gain)
	{
		case 1:
		{
		...
		case 2:
		{
			GAIN_CTRL_REF_C1_HIGH();
			GAIN_CTRL_REF_C2_LOW();
			GAIN_CTRL_MEA_C1_HIGH();
			GAIN_CTRL_MEA_C2_LOW();
			break;
		}
		case 3:
		{
			GAIN_CTRL_REF_C1_LOW();
			GAIN_CTRL_REF_C2_HIGH();
			GAIN_CTRL_MEA_C1_LOW();
			GAIN_CTRL_MEA_C2_HIGH();
			break;
		}
		default:
		{
...
Uint16 OpticalADCollect_GetGain(void)
{
	Uint16 Gain = 0;
	if (GPIO_ReadOutputDataBit(GAIN_CTRL_REF_C1_PORT,GAIN_CTRL_REF_C1_PIN))
	{
		Gain += 0;
	}
	if (GPIO_ReadOutputDataBit(GAIN_CTRL_REF_C2_PORT,GAIN_CTRL_REF_C2_PIN))
	{
		Gain += 2;
	}
	return Gain;
