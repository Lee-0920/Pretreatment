...
#define PERIPHERAL_SYSCLK                         45            //串口使用的时钟频率，APB1 为45M，APB2为90M
#define LAIRS485ADAPTER_IRQn                      UART4_IRQn
#define LAIRS485ADAPTER_CLK_CONFIG                RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART4, ENABLE)
#define LAIRS485ADAPTER_RX_GPIO_CLK_CONFIG        RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA, ENABLE)
#define LAIRS485ADAPTER_TX_GPIO_CLK_CONFIG        RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA, ENABLE)
#define LAIRS485ADAPTERx                          UART4
#define LAIRS485ADAPTER_GPIO_AF                   GPIO_AF_UART4
#define LAIRS485ADAPTER_TX_PIN                    GPIO_Pin_0
#define LAIRS485ADAPTER_TX_PinSource              GPIO_PinSource0
#define LAIRS485ADAPTER_TX_GPIO_PORT              GPIOA
#define LAIRS485ADAPTER_RX_PIN                    GPIO_Pin_1
#define LAIRS485ADAPTER_RX_PinSource              GPIO_PinSource1
#define LAIRS485ADAPTER_RX_GPIO_PORT              GPIOA
#define LAIRS485ADAPTER_UART_BAUD                 115200
