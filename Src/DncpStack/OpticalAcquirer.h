...
#define CMD_TABLE_OPTICALACQUIRE \
		...
		DSCP_CMD_ENTRY(DSCP_CMD_OAI_SET_STATIC_GAIN, OpticalAcquirer_SetGainControlParam),\
		DSCP_CMD_ENTRY(DSCP_CMD_OAI_GET_STATIC_GAIN, OpticalAcquirer_GetGainControlParam)
